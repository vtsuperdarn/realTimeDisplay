 ...
 * @author  nigel
 */
public class FitBean extends JPanel {
    
    private static final long serialVersionUID = 0x525350504700002AL;
    
    class FitDataValue extends Number {
        private static final long serialVersionUID = 0x525350504700002BL;
        
        FitDataValue(float init) {
            value = init;
        }
        public float value;
    ...
    class FitDataModel extends AbstractTableModel {
        ...
        private static final long serialVersionUID = 0x525350504700002CL;
        ...
        class FitDataData {
            ...
            FitDataData( int gate, float range, boolean gs, float pow, float vel, float w ) {
        ...
        public void addRow( int gate, float range, boolean gs, float pow, float vel, float w ) {
    ...
    public void setData( NetFitData data ) {
        ...
        dataModel.clear();
        for ( int index=0; index<data.ranges.length; index++ ) {
            dataModel.addRow(data.ranges[index],
            data.radarParms.firstRangeDistance+data.ranges[index]*data.radarParms.rangeSeparation,
            data.groundScatter[index],
            data.velocity[index],
            data.lambdaPower[index],
            data.lambdaSpectralWidth[index] );
        }
    }
